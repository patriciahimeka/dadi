...
Populations Ogasawara (O) and Daito (D)

usage: python 2D_03_third_optimizations_C-D.py
...
#======================================================================================
# Call the functions with the relevant arguments.
