...
'''
Optimization_Functions used for demographic modeling in 
Wepfer et al., "The oceanographic isolation of the Ogasawara Islands and genetic divergence in a reef-building coral" (in prep).

SCRIPT COPIED 1 TO 1 FROM DAN PORTIK's DADI_PIPELINE: https://github.com/dportik/dadi_pipeline/ (Version for Python 2.7, 2018)
